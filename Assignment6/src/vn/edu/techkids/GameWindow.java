...
public class GameWindow extends Frame implements Runnable {
    ...
    public GameWindow () {
        ...
        this.bombController = new BombController(new GameObject(100 , 500 , 50 , 50) , new ImageDrawer("resources/bomb.png"));
        this.giftController = new GiftController(new GameObject(500 , 500 , 50 , 50) , new ImageDrawer("resources/gift.gif"));
        try {
